// tmp_header.tsx - stubbed during restore
// This temporary file is intentionally left as an empty module to avoid
// TypeScript resolving historical copies. It can be removed once the
// restored `app/header.tsx` is confirmed correct.
