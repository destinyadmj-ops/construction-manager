            ...
            <div style={{ minHeight: Math.max(32, Math.round(cellMinH || 0)) }} className="relative">
              ...
              {showPersonalScheduleBadge && personalScheduleDay ? (
                ...
                >
                  ...
                  <button
                    type="button"
                    className="flex items-center gap-1 rounded px-0.5 py-0.5 text-[11px] font-bold leading-none text-emerald-600 drop-shadow-[0_1px_2px_rgba(0,0,0,0.28)] transition hover:text-emerald-700 dark:text-emerald-400 dark:hover:text-emerald-300"
