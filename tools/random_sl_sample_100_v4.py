...
csv_path='bot_v2/tools/data/btc_highvol_sanitized_v4.csv'
...
out_dir='bot_v2/tools/reports/random_sl_sample_v4'
...
out_csv=os.path.join(out_dir,'random_sl_sample_100_v4.csv')
...
with open(os.path.join(out_dir,'random_sl_sample_100_v4.json'),'w',encoding='utf-8') as jf:
    json.dump(summary,jf,ensure_ascii=False,indent=2)

print('Wrote', out_csv)
print('Wrote', os.path.join(out_dir,'random_sl_sample_100_v4.json'))
