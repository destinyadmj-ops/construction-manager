...
csv_path='bot_v2/tools/data/btc_history_2026.csv'
base = os.path.splitext(os.path.basename(csv_path))[0]

# patch top thresholds
import ast
top5_path='bot_v2/tools/reports/grid_top5_summary.csv'
...
out_dir='bot_v2/tools/reports/random_sl_sample_history'
...
out_csv=os.path.join(out_dir,'random_sl_sample_100_history.csv')
...
with open(os.path.join(out_dir,'random_sl_sample_100_history.json'),'w',encoding='utf-8') as jf:
    json.dump(summary,jf,ensure_ascii=False,indent=2)

print('Wrote', out_csv)
print('Wrote', os.path.join(out_dir,'random_sl_sample_100_history.json'))
