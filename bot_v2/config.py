...
# --- 未約定観測学習パラメータ ---
OBSERVATION_LEARN_HORIZON_SECONDS = 1800
OBSERVATION_MAX_RECORDS = 2000
OBSERVATION_DUPLICATE_COOLDOWN_SECONDS = 600
OBSERVATION_MIN_MOVE_RATIO = 0.0015
OBSERVATION_BIAS_MIN_SAMPLES = 8
OBSERVATION_MAX_SCORE_BIAS = 0.08
